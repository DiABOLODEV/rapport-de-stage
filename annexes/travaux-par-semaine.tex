...
\item \textbf{Visite, présentation et rencontre} avec les équipes de la ferme d'applications \textsc{TMA OSS\footnote{Maintenant Applicative}}. Explication de l'activité par le chef de service \textsc{Arnaud Bellina}. 
...
\end{enumerate}
Visionnage de E-Learning sur l'éthique dans l'entreprise, l'utilisation de la boite mail et processus de codage industriel
\item \textbf{Tests de non-regression de la version G1R6 sur la France métropolitaine}
