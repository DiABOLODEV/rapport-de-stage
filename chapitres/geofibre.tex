\chapter{Le projet Geofibre}
	
	\section{Objet}
Le projet Geofibre a pour objet de fournir une application de \textsc{Système d'Information Géographique (SIG)} pour le FTTH\footnote{Fiber To The Home. C'est le réseau très haut débit de fibre optique pour les clients résidentiels.}\\
